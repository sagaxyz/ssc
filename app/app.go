...
import (
	...
	upgrade3 "github.com/sagaxyz/ssc/app/upgrades/3"
	upgrade4 "github.com/sagaxyz/ssc/app/upgrades/v4"
...
func (app *App) RegisterUpgradeHandlers() {
	...
	app.UpgradeKeeper.SetUpgradeHandler(upgrade3.Name, upgrade3.UpgradeHandler(app.mm, app.configurator, app.TransferKeeper, app.BankKeeper))
	app.UpgradeKeeper.SetUpgradeHandler(upgrade4.Name, upgrade4.UpgradeHandler(app.mm, app.configurator, *app.StakingKeeper, app.LiquidKeeper))
