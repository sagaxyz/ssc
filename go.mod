...
require (
	...
	github.com/sagaxyz/saga-sdk v0.6.0
...
replace golang.org/x/exp => golang.org/x/exp v0.0.0-20230711153332-06a737ee72cb // https://github.com/cosmos/cosmos-sdk/issues/20159#issuecomment-2072925746
