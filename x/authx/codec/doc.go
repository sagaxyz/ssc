...
codec.go file as follows:
	...
	func init() {
		...
		RegisterLegacyAminoCodec(authxcodec.Amino)
	}

The codec instance is put inside this package and not the x/authx package in order to avoid any dependency cycle.
*/
package codec
