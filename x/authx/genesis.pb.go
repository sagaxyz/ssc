...
// source: cosmos/authx/v1beta1/genesis.proto
...
// GenesisState defines the authx module's genesis state.
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "cosmos.authx.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("cosmos/authx/v1beta1/genesis.proto", fileDescriptor_4c2fbb971da7c892)
}
