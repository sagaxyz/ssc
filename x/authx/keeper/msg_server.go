...
var _ authx.MsgServer = Keeper{}

// Grant implements the MsgServer.Grant method to create a new grant.
func (k Keeper) Grant(goCtx context.Context, msg *authx.MsgGrant) (*authx.MsgGrantResponse, error) {
	if strings.EqualFold(msg.Grantee, msg.Granter) {
		return nil, authx.ErrGranteeIsGranter
	}
	...
	return &authx.MsgGrantResponse{}, nil
}

// Revoke implements the MsgServer.Revoke method.
func (k Keeper) Revoke(goCtx context.Context, msg *authx.MsgRevoke) (*authx.MsgRevokeResponse, error) {
	if strings.EqualFold(msg.Grantee, msg.Granter) {
		return nil, authx.ErrGranteeIsGranter
	}
	...
	return &authx.MsgRevokeResponse{}, nil
}

// Exec implements the MsgServer.Exec method.
func (k Keeper) Exec(goCtx context.Context, msg *authx.MsgExec) (*authx.MsgExecResponse, error) {
	ctx := sdk.UnwrapSDKContext(goCtx)
	if msg.Grantee == "" {
	...
	return &authx.MsgExecResponse{Results: results}, nil
}
