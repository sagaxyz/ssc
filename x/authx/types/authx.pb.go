...
// source: ssc/authx/v1/authx.proto
...
func (*GenericAuthorization) Descriptor() ([]byte, []int) {
	return fileDescriptor_77d6881b1d32b114, []int{0}
}
...
func (*Grant) Descriptor() ([]byte, []int) {
	return fileDescriptor_77d6881b1d32b114, []int{1}
}
...
func (*GrantAuthorization) Descriptor() ([]byte, []int) {
	return fileDescriptor_77d6881b1d32b114, []int{2}
}
...
func (*GrantQueueItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_77d6881b1d32b114, []int{3}
}
...
func init() {
	proto.RegisterType((*GenericAuthorization)(nil), "ssc.authx.v1.GenericAuthorization")
	proto.RegisterType((*Grant)(nil), "ssc.authx.v1.Grant")
	proto.RegisterType((*GrantAuthorization)(nil), "ssc.authx.v1.GrantAuthorization")
	proto.RegisterType((*GrantQueueItem)(nil), "ssc.authx.v1.GrantQueueItem")
}

func init() { proto.RegisterFile("ssc/authx/v1/authx.proto", fileDescriptor_77d6881b1d32b114) }

var fileDescriptor_77d6881b1d32b114 = []byte{
	// 446 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *GenericAuthorization) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Msg) > 0 {
		i -= len(m.Msg)
		copy(dAtA[i:], m.Msg)
		i = encodeVarintAuthx(dAtA, i, uint64(len(m.Msg)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Grant) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Expiration != nil {
		...
		i -= n1
		i = encodeVarintAuthx(dAtA, i, uint64(n1))
		i--
		dAtA[i] = 0x12
	}
	if m.Authorization != nil {
		{
			...
			i -= size
			i = encodeVarintAuthx(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0xa
	}
...
func (m *GrantAuthorization) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Expiration != nil {
		...
		i -= n3
		i = encodeVarintAuthx(dAtA, i, uint64(n3))
		i--
		dAtA[i] = 0x22
	}
	if m.Authorization != nil {
	...
	if len(m.Grantee) > 0 {
		...
		i = encodeVarintAuthx(dAtA, i, uint64(len(m.Grantee)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Granter) > 0 {
		...
		i = encodeVarintAuthx(dAtA, i, uint64(len(m.Granter)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *GrantQueueItem) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MsgTypeUrls) > 0 {
		for iNdEx := len(m.MsgTypeUrls) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintAuthx(dAtA, i, uint64(len(m.MsgTypeUrls[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func encodeVarintAuthx(dAtA []byte, offset int, v uint64) int {
	offset -= sovAuthx(v)
	base := offset
	for v >= 1<<7 {
...
func sovAuthx(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozAuthx(x uint64) (n int) {
	return sovAuthx(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *GenericAuthorization) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipAuthx(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipAuthx(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthAuthx
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupAuthx
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthAuthx        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowAuthx          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupAuthx = fmt.Errorf("proto: unexpected end of group")
)
