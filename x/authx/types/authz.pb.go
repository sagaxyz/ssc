...
// source: cosmos/authx/v1beta1/authx.proto
...
func init() {
	proto.RegisterType((*GenericAuthorization)(nil), "cosmos.authx.v1beta1.GenericAuthorization")
	proto.RegisterType((*Grant)(nil), "cosmos.authx.v1beta1.Grant")
	proto.RegisterType((*GrantAuthorization)(nil), "cosmos.authx.v1beta1.GrantAuthorization")
	proto.RegisterType((*GrantQueueItem)(nil), "cosmos.authx.v1beta1.GrantQueueItem")
}

func init() { proto.RegisterFile("cosmos/authx/v1beta1/authx.proto", fileDescriptor_544dc2e84b61c637) }
