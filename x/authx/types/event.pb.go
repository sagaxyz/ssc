...
// source: cosmos/authx/v1beta1/event.proto
...
func init() {
	proto.RegisterType((*EventGrant)(nil), "cosmos.authx.v1beta1.EventGrant")
	proto.RegisterType((*EventRevoke)(nil), "cosmos.authx.v1beta1.EventRevoke")
}

func init() { proto.RegisterFile("cosmos/authx/v1beta1/event.proto", fileDescriptor_1f88cbc71a8baf1f) }
