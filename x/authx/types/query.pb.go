...
// source: cosmos/authx/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryGrantsRequest)(nil), "cosmos.authx.v1beta1.QueryGrantsRequest")
	proto.RegisterType((*QueryGrantsResponse)(nil), "cosmos.authx.v1beta1.QueryGrantsResponse")
	proto.RegisterType((*QueryGranterGrantsRequest)(nil), "cosmos.authx.v1beta1.QueryGranterGrantsRequest")
	proto.RegisterType((*QueryGranterGrantsResponse)(nil), "cosmos.authx.v1beta1.QueryGranterGrantsResponse")
	proto.RegisterType((*QueryGranteeGrantsRequest)(nil), "cosmos.authx.v1beta1.QueryGranteeGrantsRequest")
	proto.RegisterType((*QueryGranteeGrantsResponse)(nil), "cosmos.authx.v1beta1.QueryGranteeGrantsResponse")
}

func init() { proto.RegisterFile("cosmos/authx/v1beta1/query.proto", fileDescriptor_376d714ffdeb1545) }
...
func (c *queryClient) Grants(ctx context.Context, in *QueryGrantsRequest, opts ...grpc.CallOption) (*QueryGrantsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.authx.v1beta1.Query/Grants", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GranterGrants(ctx context.Context, in *QueryGranterGrantsRequest, opts ...grpc.CallOption) (*QueryGranterGrantsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.authx.v1beta1.Query/GranterGrants", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GranteeGrants(ctx context.Context, in *QueryGranteeGrantsRequest, opts ...grpc.CallOption) (*QueryGranteeGrantsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.authx.v1beta1.Query/GranteeGrants", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Grants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.authx.v1beta1.Query/Grants",
	}
...
func _Query_GranterGrants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.authx.v1beta1.Query/GranterGrants",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_GranteeGrants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.authx.v1beta1.Query/GranteeGrants",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cosmos.authx.v1beta1.Query",
	...
	Metadata: "cosmos/authx/v1beta1/query.proto",
}
