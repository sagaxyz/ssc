...
type MsgLaunchChainlet struct {
	...
	CustomGenesisValidators       []string       `protobuf:"bytes,13,rep,name=customGenesisValidators,proto3" json:"customGenesisValidators,omitempty"`
}
...
func (m *MsgLaunchChainlet) GetCustomGenesisValidators() []string {
	if m != nil {
		return m.CustomGenesisValidators
	}
	return nil
}
...
var fileDescriptor_7e7ff960f25a570e = []byte{
	...
	,
}
...
func (m *MsgLaunchChainlet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CustomGenesisValidators) > 0 {
		for iNdEx := len(m.CustomGenesisValidators) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.CustomGenesisValidators[iNdEx])
			copy(dAtA[i:], m.CustomGenesisValidators[iNdEx])
			i = encodeVarintTx(dAtA, i, uint64(len(m.CustomGenesisValidators[iNdEx])))
			i--
			dAtA[i] = 0x6a
		}
	}
...
func (m *MsgLaunchChainlet) Size() (n int) {
	...
	if len(m.CustomGenesisValidators) > 0 {
		for _, s := range m.CustomGenesisValidators {
			l = len(s)
			n += 1 + l + sovTx(uint64(l))
		}
	}
...
func (m *MsgLaunchChainlet) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CustomGenesisValidators", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CustomGenesisValidators = append(m.CustomGenesisValidators, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
